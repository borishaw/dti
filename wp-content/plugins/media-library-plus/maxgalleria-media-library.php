...
class MaxGalleriaMediaLib {
  ...
  public function __construct() {
	...
	public function set_global_constants() {	
		...
		define('MAXGALLERIA_MEDIA_LIBRARY_VERSION_NUM', '3.0.1');
        ...
        <div id='mgmlp-title-area'>
          <h2 class='mgmlp-title'><?php _e('Media Library Plus', 'maxgalleria-media-library' ); ?> </h2>    
					...
					<div id="new-top-promo">
						...
						<p class="center-text"><?php _e('Makers of', 'maxgalleria-media-library' ); ?> <a target="_blank"  href="http://maxbuttons.com/">MaxButtons</a> <?php _e('and', 'maxgalleria-media-library' ); ?> <a target="_blank" href="http://maxinbound.com/">MaxInbound</a></p>
						<p class="center-text"><?php _e('Media Library Plus works great with', 'maxgalleria-media-library' ); ?> <a target="_blank"  href="http://maxgalleria.com/">MaxGalleria</a></p>
					</div>
...
//    echo '  <div class="media-plus-toolbar wp-filter"><div class="media-toolbar-secondary">' . PHP_EOL;
  ...
  public function mlp_review_notice_rate() {
    if( current_user_can( 'manage_options' ) ) {  ?>
      <div class="updated notice maxgalleria-mlp-notice">         
        <div id='mlp_logo'></div>
