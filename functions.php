...
function dti_scripts() {
	...
	wp_enqueue_style( 'dti-googlefonts', 'https://fonts.googleapis.com/css?family=Reenie+Beanie|Roboto:400,300,700,700italic,400italic');
	wp_enqueue_style( 'dti-fontawesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css');
	wp_enqueue_style( 'dti-entypo', 'https://cdn.jsdelivr.net/font-entypo/0.1/dev/entypo.css');
	wp_enqueue_style( 'dti-simpleline', 'https://cdnjs.cloudflare.com/ajax/libs/simple-line-icons/2.2.4/css/simple-line-icons.min.css');
	wp_enqueue_style( 'dti-drawer-css', 'https://cdnjs.cloudflare.com/ajax/libs/drawer/3.2.0/css/drawer.min.css');
	wp_enqueue_script( 'dti-iscroll', 'https://cdnjs.cloudflare.com/ajax/libs/iScroll/5.1.3/iscroll.min.js', array('jquery'), '20160306', true );
	wp_enqueue_script( 'dti-drawer-js', 'https://cdnjs.cloudflare.com/ajax/libs/drawer/3.2.0/js/drawer.min.js', array('jquery'), '20160306', true );
	...
	if(is_singular('trip')) {
		wp_enqueue_style( 'dti-bootstrap-style', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css');
		wp_enqueue_style( 'dti-owl', 'https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.css');
		wp_enqueue_style( 'dti-owl-theme', 'https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.theme.min.css');
		wp_enqueue_style( 'dti-owl-transitions', 'https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.transitions.min.css');
		wp_enqueue_script( 'dti-owl-script', 'https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.js', array('jquery'), '20160306', true );
		wp_enqueue_script( 'dti-bootstrap-script', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js', array('jquery'), '20160306', true );
		wp_enqueue_script( 'dti-sticky', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.sticky/1.0.3/jquery.sticky.min.js', array('jquery'), '20160306', true );
	}
